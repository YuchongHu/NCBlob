...
#include "ErasureCodePluginLonse.h"
...
int ErasureCodePluginLonse::factory(const std::string &directory,
				   ceph::ErasureCodeProfile &profile,
				   ceph::ErasureCodeInterfaceRef *erasure_code,
				   std::ostream *ss) {
  auto interface = std::make_unique<ErasureCodeLonse>(directory);
...
int __erasure_code_init(char *plugin_name, char *directory)
{
  ...
  return instance.add(plugin_name, new ErasureCodePluginLonse());
}
